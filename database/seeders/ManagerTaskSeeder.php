...
class ManagerTaskSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $tasks = [
            // ── SM TASKS — DAILY ──────────────────────────────────────
            ['role_target'=>'SM', 'frequency'=>'daily',     'order'=>1,  'category'=>'Monitoring',       'title'=>'Check Brand Complaint',                           'url'=>null],
            ['role_target'=>'SM', 'frequency'=>'daily',     'order'=>2,  'category'=>'Monitoring',       'title'=>'Check CE Tracker',                                'url'=>null],
            ['role_target'=>'SM', 'frequency'=>'daily',     'order'=>3,  'category'=>'Monitoring',       'title'=>'Check Waste Alert',                               'url'=>null],
            ['role_target'=>'SM', 'frequency'=>'daily',     'order'=>4,  'category'=>'Operasional',      'title'=>'Pembuatan CP (Customer Proposal)',                 'url'=>null],
            ['role_target'=>'SM', 'frequency'=>'daily',     'order'=>5,  'category'=>'Kualitas',         'title'=>'Oil Test Strip & Monitoring',                     'url'=>null],
            ['role_target'=>'SM', 'frequency'=>'daily',     'order'=>6,  'category'=>'Operasional',      'title'=>'DSTO (Daily Stock Take Out)',                      'url'=>null],
            ...
            ['role_target'=>'SM', 'frequency'=>'monday',    'order'=>3,  'category'=>'Pengadaan',        'title'=>'Pembuatan PR Vendor',                             'url'=>null],
            ['role_target'=>'SM', 'frequency'=>'monday',    'order'=>4,  'category'=>'Pengadaan',        'title'=>'Konfirmasi Dry',                                  'url'=>null],

            // ── SM TASKS — SELASA ─────────────────────────────────────
            ['role_target'=>'SM', 'frequency'=>'tuesday',   'order'=>1,  'category'=>'Operasional',      'title'=>'QTY Minyak Jelantah',                             'url'=>null],
            ['role_target'=>'SM', 'frequency'=>'tuesday',   'order'=>2,  'category'=>'Equipment',        'title'=>'Cek Equipment Troubleshoot & Temuan Rentokil',    'url'=>null],
